    ...
    public class DataInteropHandler : IDataInteropHandler
    {
        ...
        public unsafe IEntityCommand GetCommand(UInt32 type, IntPtr data, Int32 dataSize)
        {
            switch (type)
            {
                  ...
                  case 7: return _b6b91167bdda7fd42ac20fbdb992aeca_217c5f05bfa3471ab86e4f32e0f9dc9b.FromInterop(data, dataSize);
                  case 8: return _b6b91167bdda7fd42ac20fbdb992aeca_a202db9439ec408e8c17770e581736b1.FromInterop(data, dataSize);
            }
        ...
        public unsafe bool SendCommand(INativeCoreCommandSender sender, InteropEntity entity, MessageTarget target, IEntityCommand command)
        {
            ...
            switch (type)
            {
                ...
                case 7:
                {
                    var orig = (_b6b91167bdda7fd42ac20fbdb992aeca_217c5f05bfa3471ab86e4f32e0f9dc9b)command;
                    var val = new _b6b91167bdda7fd42ac20fbdb992aeca_217c5f05bfa3471ab86e4f32e0f9dc9b.Interop();

                    var pinnedcompleteMessage = orig.completeMessage != null ? Encoding.UTF8.GetBytes(orig.completeMessage) : null; fixed (void* pinnedPtrcompleteMessage = pinnedcompleteMessage) { val.completeMessage = new ByteArray { Data = pinnedPtrcompleteMessage, Length =  pinnedcompleteMessage?.Length ?? 0 };
