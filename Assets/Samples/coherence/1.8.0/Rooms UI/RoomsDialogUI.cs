...
namespace Coherence.Samples.RoomsDialog
{
    ...
    using Y200.ProjectMultiplayer;

    public class RoomsDialogUI : MonoBehaviour
    {
        [SerializeField] private PlayerSkinManager _playerSkin;
        ...
        private void Awake()
        {
            _playerSkin.SkinID = Guid.NewGuid();
        ...
        private void OnBridgeDisconnected(CoherenceBridge _, ConnectionCloseReason reason)
        {
            ...
            GlobalEvent.OnWorldDisconnected?.Invoke(_playerSkin.SkinID);
        }
        ...
        private void OnBridgeConnected(CoherenceBridge _)
        {
            ...
            GlobalEvent.OnWorldConnected?.Invoke(_playerSkin.SkinID);
        }
